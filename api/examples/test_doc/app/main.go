...
import (
	_ "github.com/haozzzzzzzz/go-tool/api/examples/test_doc/app/first_init"
	// 空一行

	"github.com/haozzzzzzzz/go-tool/api/examples/test_doc/app/api"
	"github.com/haozzzzzzzz/go-tool/api/examples/test_doc/app/constant"

	_ "service/common/session/app"

	_ "github.com/haozzzzzzzz/go-tool/api/examples/test_doc/common/config"
	...
	"github.com/haozzzzzzzz/go-tool/api/examples/test_doc/common/config"
